...
function generateEmailWorkout() {
    ...
    <html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" style="width:100%;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
     <head>
      ...
      <title>Pledge Of Completion</title><!--[if (mso 16)]>
        <style type="text/css">
      ...
      <div class="es-wrapper-color" style="background-color:#F9F9F9"><!--[if gte mso 9]>
       ...
       <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top;background-color:#F9F9F9">
                 ...
                 <tr style="border-collapse:collapse">
                  <td align="left" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:40px;padding-bottom:40px">
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr style="border-collapse:collapse">
                      <td align="center" style="padding:0;Margin:0;border-radius:24px;overflow:hidden;width:580px">
                       <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-left:1px solid #e1effc;border-right:1px solid #e1effc;border-top:1px solid #e1effc;border-bottom:1px solid #e1effc;background-color:#ffffff;border-radius:24px;box-shadow:#cccccc 0px 20px 20px" role="presentation">
                         <tr style="border-collapse:collapse">
                          <td align="left" class="es-m-txt-l" bgcolor="#333333" style="Margin:0;padding-bottom:25px;padding-top:30px;padding-left:30px;padding-right:30px"><h2 style="Margin:0;line-height:30px;mso-line-height-rule:exactly;font-family:'Roboto Condensed', 'Arial Narrow', Arial, sans-serif;font-size:25px;font-style:normal;font-weight:normal;color:#ffffff"><strong>Your Workout plan is completed you can check it</strong></h2></td>
                         </tr>
                         <tr style="border-collapse:collapse">
                          <td align="left" bgcolor="#f1c232" style="Margin:0;padding-top:15px;padding-bottom:15px;padding-left:30px;padding-right:30px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;font-size:16px">Your personalized Workout plan has been completed. You can now review and check it.</p></td>
                         </tr>
                         <tr style="border-collapse:collapse">
                          <td align="left" style="Margin:0;padding-top:25px;padding-bottom:30px;padding-left:30px;padding-right:30px"><!--[if mso]><a href="http://localhost:3000" target="_blank" hidden>
        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="http://localhost:3000"" 
                    style="height:38px; v-text-anchor:middle; width:145px" arcsize="32%" strokecolor="#2f80ed" strokeweight="1px" fillcolor="#f1c232">
            <w:anchorlock></w:anchorlock>
            
            <center style='color:#333333; font-family:roboto, "helvetica neue", helvetica, arial, sans-serif; font-size:14px; font-weight:400; line-height:14px;  mso-text-raise:1px'>Go check !</center>
        </v:roundrect></a>
    <![endif]--><!--[if !mso]><!-- --><span class="msohide es-button-border" style="border-style:solid;border-color:#2F80ED;background:#f1c232;border-width:0px 0px 2px 0px;display:inline-block;border-radius:12px;width:auto;mso-hide:all"><a href="https://viewstripo.email/" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#333333;font-size:16px;padding:10px 25px 10px 25px;display:inline-block;background:#f1c232;border-radius:12px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;font-weight:normal;font-style:normal;line-height:19px;width:auto;text-align:center;mso-padding-alt:0;mso-border-alt:10px solid #f1c232">Go check !</a></span><!--<![endif]--></td>
                         </tr>
                       </table></td>
                     </tr>
                   </table></td>
